...
class StockTradingRuleCreate(BaseModel):
    ...
    price_limit_type: str = Field(min_length=1, max_length=32)
    normal_price_limit_ratio: Decimal | None = Field(default=None, ge=0)
    special_price_limit_ratio: Decimal | None = Field(default=None, ge=0)
